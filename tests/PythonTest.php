    ...
    public function testDecode() {
        $values = [
            ...
            "{'result': {'attributes': {'network_scan': {'time_allowed': ((0, 0), (24, 0)), 'run_as': u'automation',
                ...
                'result_code': 0}",
            "{'result': {'site_id': 'apitestslave', 'site_config': {'url_prefix': 'http://10.10.30.230/apitestslave/',
                'status_host': None, 'multisiteurl': 'http://10.10.30.230/apitestslave/check_mk/', 'user_sync': 'all',
                'socket': ('proxy', {'params': None, 'socket': ('10.10.30.230', 6557)}), 'alias': u'slave',
                'user_login': True, 'insecure': True, 'disable_wato': True, 'disabled': False, 'replication': 'slave',
                'secret': 'ZR5=3<MG=KT04ZK853NBZ<9R4KNVE@WG', 'timeout': 10, 'persist': False, 'replicate_ec': False,
